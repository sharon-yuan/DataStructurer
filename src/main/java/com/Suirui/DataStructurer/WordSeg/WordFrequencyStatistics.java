...
public class WordFrequencyStatistics {
    ...
    public static void  executor(String inputPath,String outputPath){
    	 WordFrequencyStatistics wordFrequencyStatistics = new WordFrequencyStatistics();
         wordFrequencyStatistics.setRemoveStopWord(true);
        ...
        wordFrequencyStatistics.reset();
         //对文件进行分词
         try {
			wordFrequencyStatistics.seg(new File(inputPath), new File(outputPath));
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
         //输出词频统计结果
         wordFrequencyStatistics.dump(outputPath);
